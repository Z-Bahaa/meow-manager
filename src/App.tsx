...
import { CatList } from "./pages/cats/list";
import { CatCreate } from "./pages/cats/create";
import { CatEdit } from "./pages/cats/edit";
import { CatShow } from "./pages/cats/show";
import { LitterList } from "./pages/litters/list";
import { LitterCreate } from "./pages/litters/create";
import { LitterEdit } from "./pages/litters/edit";
...
function App() {
  ...
  const customTitleHandler = ({ resource, action, params }: any) => {
    let title = "Meow Manager"; // Default title
              ...
              <Refine
                ...
                resources={[
                  ...
                  },
                  {
                    name: "litters",
                    list: "/litters",
                    create: "/litters/create",
                    edit: "/litters/edit/:id",
                    show: "/litters/show/:id",
                    meta: {
                      canDelete: true,
                      label: "Litters",
                ...
                <Routes>
                  ...
                  >
                    <Route
                      path="/"
                      index
                      element={<NavigateToResource resource="cats" />}
                    />
                    <Route path="/cats" element={<CatList />} />
                    <Route path="/cats/create" element={<CatCreate />} />
                    <Route path="/cats/edit/:id" element={<CatEdit />} />
                    <Route path="/cats/show/:id" element={<CatShow />} />
                    <Route path="/litters" element={<LitterList />} />
                    <Route path="/litters/create" element={<LitterCreate />} />
                    <Route path="/litters/edit/:id" element={<LitterEdit />} />
                    <Route path="/litters/show/:id" element={<LitterShow />} />
                  </Route>
                  <Route
                    element={
                      <Authenticated
